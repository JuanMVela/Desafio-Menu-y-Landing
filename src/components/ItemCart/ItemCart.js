      ...
      <ul class="flex flex-col divide-y divide-gray-700">
        <li class="flex flex-col py-6 sm:flex-row sm:justify-between">
          <div class="flex w-full space-x-4 sm:space-x-4">
            <img
              class="flex-shrink-0  w-60 h-20 dark:border-transparent rounded outline-none sm:w-32 sm:h-32 dark:bg-gray-500"
              src={product.img}
              alt="Polaroid camera"
            />
            <div class="flex flex-col justify-between w-full pb-4">
              ...
              <div class="flex text-sm divide-x">
                ...
                >
                  ...
                  <span onClick={() => removeProductInCart(product.id)}>
                    Remove
                  </span>
                </button>
                <button
                ...
                >
                  ...
                  <span onClick={() => alert("se agrego a favorito")}>
                    Add to favorites
                  </span>
                </button>
              </div>
        ...
        <li class="flex flex-col  sm:flex-row sm:justify-between"></li>
      </ul>
    </div>
  );
};
