    ...
    <div class="max-w-sm">
      <div class="bg-white relative  hover:shadow-xl transition duration-500 rounded-lg ">
        ...
        <div class="py-6 px-8 rounded-lg bg-white">
          <h1 class="text-gray-700 font-bold text-xl mb-3 w-auto h-20 hover:text-red-900 hover:cursor-pointer">{data.title}</h1>
          <p class="text-gray-700 tracking-wide">{data.category}</p>
          <button class="mt-6 py-2 px-4 bg-[#171717] text-gray-50 font-bold rounded-lg  hover:shadow-lg transition duration-300">Buy Now</button>
        </div>
